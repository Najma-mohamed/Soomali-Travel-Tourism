...
const Header = () => {
    return (
        <div className="bg-cover  bg-center bg-no-repeat mb-[880px] sm:mb-4    h-[1500px] sm:h-[830px] bg-[url(https://images.pexels.com/photos/450062/pexels-photo-450062.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2)]">
            <div className="bg-amber-50 px-2 sm:px-12">
            ...
            <div className="bg-gray-300   sm:flex sm:w-[1300px] w-[370px]  sm:ml-28 rounded-tl-xl rounded-br-4xl justify-between sm:px-12 h-[1050px] ml-2  sm:h-[470px]">
